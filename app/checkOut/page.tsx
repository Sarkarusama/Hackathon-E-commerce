        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white border rounded-lg mb-4 p-4 shadow-md">
              ...
              cartItems.map((item) => (
                <div key={item._id} className="flex items-center gap-4 py-3 border-b">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-gray-500">Quantity : {item.inventory}</p>
                  </div>
            ...
            <div className="text-right pt-4 "> 
                ...
                <p className="text-sm mb-1">Discount: <span className="font-medium">${discount}</span></p>
                <p className="text-lg ">Total: <span className="font-semibold">${subTotal.toFixed(2)}</span></p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-1 gap-4">
                <div>
                    ...
                    <input
                     ...
                     {
                        formError.firstName &&(
                            <p className="text-sm text-red-700">First Name is Required!</p>
                        )
                     }
                </div>
                <div>
                ...
                <div>
                    ...
                    <input
                     ...
                     />
                      {
                        formError.phone &&(
                            <p className="text-sm text-red-700">Phone Number is Required!</p>
                        )
                     }
                </div>
                <div>
