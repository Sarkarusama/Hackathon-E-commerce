...
const Login = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-[500px]">
      {/* Right Section */}
      <div className="flex-1 mb-4 mt-4 bg-[#F0F2F3] flex justify-center items-center">
        <Image
                      src={require("@/public/logo/logo-icon.svg")}
                      alt="comforty-logo"
                      className="w-14  lg:w-16"
                    />
                    <p className="hover:cursor-pointer text-3xl lg:text-5xl sm:py-1 font-semibold pl-1">
                      Comforty
                    </p>
      </div>
      ...
      <div className="flex-1 bg-white flex flex-col justify-center px-8 lg:px-20">
        <SignedIn>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-lg text-center">
              ...
              <span className="font-bold text-black">USAMA</span> to get a
        ...
        <SignedOut>
          ...
          <div>
            ...
            <div className="text-center bg-[#029FAE] text-white py-3 rounded-lg hover:bg-[#3abeca]">
